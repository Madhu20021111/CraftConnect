        ...
        <aside className="w-full md:w-64 shrink-0">
          <div className="glass p-6 rounded-2xl border border-craft-border/50 shadow-sm md:sticky top-8">
            <div className="flex items-center gap-4 mb-8 pb-6 border-b border-craft-border/50">
              <div className="w-12 h-12 rounded-full bg-craft-accent text-white flex items-center justify-center font-serif text-xl font-bold shadow-md">
                JD
              </div>
              <div>
                <h3 className="font-bold text-craft-dark text-[15px]">Jane Doe</h3>
            ...
            <div className="mt-12 pt-6 border-t border-craft-border/50">
              <button className="w-full text-left px-4 py-2 text-[12px] font-bold text-red-500 hover:bg-red-50 rounded-xl transition-colors">
                Sign Out
              </button>
            </div>
          </div>
